/**
 * mutex.c - Mutex implementation of the concurrent linked list lab
 *
 * Usage:
 *   ./mutex n m mMember mInsert mDelete num_threads [seed]
 *
 * Output:
 *   Prints CSV: case,mutex,num_threads,rep,time_us,seed
 */
